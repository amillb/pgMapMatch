...
travelCostCol = 'cost'      # generalized cost to go from startNode to endNode. Expressed in seconds to traverse the edge (see https://gis.stackexchange.com/questions/198200/how-are-cost-and-reverse-cost-computed-in-pgrouting)
